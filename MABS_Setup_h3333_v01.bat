...
set "temp_computername=!COMPUTERNAME: =_!"
IF /I "!temp_computername!" == "3900X" (
    echo Forbidden to run %dpnx0 in computer "3900X" ... "!temp_computername!"
    pause
    goto :eof
)
...
REM Create a .bat to Download h3333 MABS and extract it onto the sandbox system
set "f=%USERPROFILE%\Desktop\h3333-RUNME_init_mabs.bat"
DEL "%f%">NUL 2>&1
echo @ECHO ON >> "%f%"
echo mkdir C:\MABS >> "%f%"
echo mkdir C:\TEMP >> "%f%"
...
REM echo curl -L --verbose --output "C:\TEMP\media-autobuild_suite-master.zip" https://github.com/m-ab-s/media-autobuild_suite/archive/master.zip >> "%f%"
echo curl -L --verbose --output "C:\TEMP\media-autobuild_suite-master.zip" https://github.com/hydra3333/media-autobuild_suite/archive/master.zip >> "%f%"
...
set "f=%USERPROFILE%\Desktop\generic-RUNME_init_mabs.bat"
DEL "%f%">NUL 2>&1
echo @ECHO ON >> "%f%"
echo mkdir C:\MABS >> "%f%"
echo mkdir C:\TEMP >> "%f%"
...
REM echo curl -L --verbose --output "C:\TEMP\media-autobuild_suite-master.zip" https://github.com/hydra3333/media-autobuild_suite/archive/master.zip >> "%f%"
echo powershell -NoLogo -ExecutionPolicy Unrestricted -Sta -NonInteractive -WindowStyle Normal -command "Expand-Archive -Force -LiteralPath 'C:\TEMP\media-autobuild_suite-master.zip' -DestinationPath C:\TEMP" >> "%f%"
echo curl -L --verbose --output "C:\TEMP\media-autobuild_suite-master\build\media-autobuild_suite.ini" https://raw.githubusercontent.com/hydra3333/media-autobuild_suite/master/build/media-autobuild_suite.ini >> "%f%"
echo curl -L --verbose --output "C:\TEMP\media-autobuild_suite-master\build\ffmpeg_options.txt" https://raw.githubusercontent.com/hydra3333/media-autobuild_suite/master/build/ffmpeg_options.txt >> "%f%"
echo xcopy C:\TEMP\media-autobuild_suite-master\*.* C:\MABS\ /e /v /f /h /r /y >> "%f%"
REM
REM echo REM create our own copy of vscode freom the host system onto the sandbox system >> "%f%"
REM echo mkdir C:\SOFTWARE\vscode >> "%f%"
