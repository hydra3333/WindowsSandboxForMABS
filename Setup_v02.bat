...
echo xcopy C:\MABS\build\*.txt  C:\HOST_MABS\_save\ /v /f /h /r /y >> "%f%"
echo xcopy C:\MABS\build\*.ini  C:\HOST_MABS\_save\ /v /f /h /r /y >> "%f%"
echo xcopy C:\MABS\build\*.log  C:\HOST_MABS\_save\ /v /f /h /r /y >> "%f%"
echo xcopy C:\MABS\build\*.sh   C:\HOST_MABS\_save\ /v /f /h /r /y >> "%f%"
echo xcopy C:\MABS\build\*.bat  C:\HOST_MABS\_save\ /v /f /h /r /y >> "%f%"
