...
REM xcopy ".\exe_x64_py\*.*" "C:\SOFTWARE\ffmpeg\0-homebuilt-x64\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
...
REM ------------------------------------------------------------------------------------------
REM ------------------------------------------------------------------------------------------
rem xcopy ".\exe_x64_py\*.*" "C:\SOFTWARE\youtube-dl\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
rem xcopy ".\exe_x64_py\libfftw3*.dll" "C:\SOFTWARE\youtube-dl\" /Y /E /V /F /G /H /R /Z /C
REM ------------------------------------------------------------------------------------------
REM ------------------------------------------------------------------------------------------
...
xcopy ".\exe_x64_py\ff*.exe" "C:\SOFTWARE\audacity\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
xcopy ".\exe_x64_py\libfftw3*.exe" "C:\SOFTWARE\audacity\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
xcopy ".\exe_x64_py\mediainfo.exe" "C:\SOFTWARE\audacity\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
...
REM ------------------------------------------------------------------------------------------
REM ------------------------------------------------------------------------------------------
REM ECHO AVSPLUS371_x64 takes over from AVSPLUS370_x64 since avisynth 3.7.1 is out now and the new ffmpeg should go to 3.7.1 not 3.7.0
REM xcopy ".\exe_x64_py\ff*.exe" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS371_x64\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
REM xcopy ".\exe_x64_py\libfftw3*.dll" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS371_x64\" /Y /E /V /F /G /H /R /Z /C
REM xcopy ".\exe_x64_py\libfftw3*.dll" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS371_x64\plugins\" /Y /E /V /F /G /H /R /Z /C
REM xcopy ".\exe_x64_py\ff*.exe" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS372_x64\" /Y /E /V /F /G /H /R /Z /C /exclude:xcopyexcludedfileslist1.txt
REM xcopy ".\exe_x64_py\libfftw3*.dll" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS372_x64\" /Y /E /V /F /G /H /R /Z /C
REM xcopy ".\exe_x64_py\libfftw3*.dll" "C:\SOFTWARE\AVISynth\AvisynthRepository\AVSPLUS372_x64\plugins\" /Y /E /V /F /G /H /R /Z /C
REM ------------------------------------------------------------------------------------------
REM ------------------------------------------------------------------------------------------
